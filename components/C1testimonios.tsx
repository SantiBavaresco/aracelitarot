...
import YouTubePlayer from "./youtubepayer";
import { C1Testimonios } from "@/config/C1Testimonios-data";
        ...
        <div className="lg:flex gap-10 -mt-10">
            ...
            {C1Testimonios.data.map((item, index) => (
                <div key={`Testimonio-${index}`} className=" text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-800 flex-1">
                        ...
                        <div className="container ">
                            <div className=" text-center mb-4">
                                ...
                                <p className="leading-relaxed text-lg -mt-4 dark:text-gray-300">
                                    {C1Testimonios.data[index].testimonial}
                                </p>
                                ...
                                <h2 className="text-gray-900 font-medium -mt-4 title-font tracking-wider text-sm dark:text-high-orange">
                                    {C1Testimonios.data[index].name}
                                </h2>
                                <p className="text-gray-500 dark:text-gray-300">
                                    {C1Testimonios.data[index].rank}
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <YouTubePlayer
                        url={C1Testimonios.data[index].videoId}
                        height={"391"}
                        width={"220"}
						autoplay={0}
                    />
